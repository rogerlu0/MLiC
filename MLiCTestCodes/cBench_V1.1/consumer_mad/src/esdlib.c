...
//            if (preload2 && (lib = strstr(preload2,"libesddsp")))
//                do {
...
//                    putenv(preload2);
//                } while (strstr(preload2,"libesddsp"));
//            cmd = malloc(strlen(SERVERDIR"/esd  -spawnfd 9999999999") + (esd_spawn_options?strlen(esd_spawn_options):0));
